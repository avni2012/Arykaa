                        ...
                        @if(!empty($vendors))
                          ...
                          <div class="row align-items-center">
                            ...
                            @if(count($vendor->product_vendor_details) > 0)
                              <div class="col-sm-3">
                                <input type="number" min="0" name="price[]" id="price" class="form-control" placeholder="Price" value="{{ old('price',$vendor->product_vendor_details->first()->price) }}">
                              </div>
                              <div class="col-sm-3">
                                <input type="text" name="SKU[]" id="SKU" class="form-control" placeholder="SKU" value="{{ old('SKU',$vendor->product_vendor_details->first()->SKU) }}">
                              </div>
                            @else
                              <div class="col-sm-3">
                                <input type="number" min="0" name="price[]" id="price" class="form-control" placeholder="Price" value="{{ old('price') }}">
                              </div>
                              <div class="col-sm-3">
